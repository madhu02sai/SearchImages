...
namespace FlickrWebApplicationRazorPages.Tests.Flickr
{
    class FlickrPhotoServiceTests
    {
        ...
        public async Task GetPhotosListByTag_WhenFlickrServiceWorks_GivesCorrectResult()
        {
            ...
            // Create the HttpMessageHandler mock
            ...
            //Act
            List<string> photoURLs = await new FlickrPhotoService().GetPhotosListByTag(tag);
            ...
            Assert.AreEqual(photosCount, photoURLs.Count());
            Assert.AreEqual("https://live.staticflickr.com/65535/51352778937_1964531968_q.jpg", photoURLs[0]);
            Assert.AreEqual("https://live.staticflickr.com/65535/51176669817_0f195e8da0_q.jpg", photoURLs[9]);
        }
        ...
        public async Task GetPhotosListByTag_WhenFlickrServiceFails_GivesCorrectResult()
        {
            ...
            //Act
            Assert.ThrowsAsync<Exception>(() => new FlickrPhotoService().GetPhotosListByTag(tag));
        ...
        public async Task GetPhotoUrl_WhenCalled_GivesCorrectUrl()
        {
            ...
            //Act
            String url = new FlickrPhotoService().GeneratePhotoUrl(photo);
